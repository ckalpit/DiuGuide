...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonSayHi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String uri = String.format(Locale.ENGLISH, "http://maps.google.com/maps?&daddr=%f,%f (%s)",20.7100, 70.9800, "Diu",0, 0, "My Location");
    ...
    //    mMapView.setBuiltInZoomControls(true);
        ...
        double latitude = 20.7100;
        double longitude = 70.9800;

        // create marker
        MarkerOptions marker = new MarkerOptions().position(
                new LatLng(latitude, longitude)).title("Welcome To Diu");
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(new LatLng(20.7100, 70.9800)).zoom(12).build();
